 ...
 */
 ...
 class ConfigurationManager implements IManager
 {
    ...
    /**
     * Cambia el valor de nombre en una sección dada. Este método no altera el fichero en disco.
     */
    public function SetName ($section, $name, $value)
    {
        // Se divide en dos pasos para evitar "confusiones" del PHP
		$sectionConfig = $this->Mapping->$section;
		$sectionConfig[$name] = $value;

        // Se actualiza el valor
		$this->Mapping->$section = $sectionConfig;
